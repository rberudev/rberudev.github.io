    ...
    en: {
        ...
        "app1-title": "Tzatziki",
        "app1-desc": "Greek yogurt, cucumber, garlic, and olive oil served with pita bread.",
        "app2-title": "Saganaki",
        ...
        "main2-title": "Souvlaki Platter",
        "main2-desc": "Grilled pork or chicken skewers served with fries, pita, and tzatziki."
    },
    el: {
        // Navigation & Global
        "nav-home": "Αρχική",
        ...
        "app1-title": "Τζατζίκι",
        "app1-desc": "Στραγγιστό γιαούρτι, αγγούρι, σκόρδο και ελαιόλαδο, σερβίρεται με πίτα.",
        "app2-title": "Σαγανάκι",
...
"app7-desc": "Τραγανά απ' έξω, ζουμερά από μέσα, ζυμωμένα με φρέσκο δυόσμο και σκόρδο.",
        ...
        "main2-title": "Ποικιλία Σουβλάκι",
        "main2-desc": "Καλαμάκια χοιρινό ή κοτόπουλο, σερβίρονται με πατάτες τηγανητές, πίτα και τζατζίκι."
    }
};
